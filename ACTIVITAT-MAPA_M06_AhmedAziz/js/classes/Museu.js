...
// Clase para museos, hereda de PuntInteres
export class Museu extends PuntInteres {
    constructor(id, pais, ciutat, nom, direccio, tipus, latitud, longitud, puntuacio, horaris, preu, moneda, descripcio, esManual = false) {
